...
const LoanIssued = () => {
    ...
    //read contracts
  const getAllTheRequests = React.useMemo(() => getAllLenderRequest(account.address), [account.address])
        ...
        {dataArray.map((item, index) => (
                        <Card className="mb-4" key={index}>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <h4>{Number(formatEther(item.collateralAmount))}LISK</h4>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <h4>{item.funded? <Badge variant="active">In PROGRESS</Badge> : <Badge variant="inactive">PAID</Badge>}</h4>
                            ...
                            {item.funded? <Button  onClick={()=>handleApproveTransaction(index,(item.tokenAmount + item.tokenProfit))} variant="accent">CLAIM</Button> : <Button disabled={true} variant="destructive">CLAIMED</Button>}
