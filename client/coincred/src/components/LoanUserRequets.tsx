...
const LoanUserRequests = () => {
  ...
  //read contracts
  const getAllTheRequests = React.useMemo(() => getAllUserLoanRequests(account.address), [account.address])
        ...
        {dataArray.map((item, index) => (
                        <Card className="mb-4" key={index}>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <h4>{item.funded? <Badge variant="active">active</Badge> : <Badge variant="inactive">inactive</Badge>}</h4>
